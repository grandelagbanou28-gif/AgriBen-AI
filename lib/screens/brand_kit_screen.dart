    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('Poppins', style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
          const SizedBox(height: 8),
          Text('ABCDEFGHIJKLMNOPQRSTUVWXYZ', style: GoogleFonts.poppins(fontSize: 13, color: AppColors.textSecondary)),
          Text('abcdefghijklmnopqrstuvwxyz', style: GoogleFonts.poppins(fontSize: 13, color: AppColors.textSecondary)),
          Text('0123456789 FCFA', style: GoogleFonts.poppins(fontSize: 13, color: AppColors.textSecondary)),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            'AgriBen - Agriculture',
            style: GoogleFonts.poppins(fontSize: 16, fontWeight: weight, color: AppColors.textPrimary),
          ),
        ],
      ),
    );
