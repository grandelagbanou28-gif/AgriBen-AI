...
class LogoAbstractAgri extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(cx + w * 0.26, cy - h * 0.08), 4.0, dot1);
    final dot1Ring = Paint()
      ..color = const Color(0xFFFBBF24).withValues(alpha: 0.4)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1.5;
    canvas.drawCircle(Offset(cx + w * 0.26, cy - h * 0.08), 7.0, dot1Ring);

    final dot2 = Paint()..color = const Color(0xFF4ADE80);
    canvas.drawCircle(Offset(cx - w * 0.24, cy + h * 0.14), 3.0, dot2);

    final dot3 = Paint()..color = const Color(0xFF86EFAC);
    canvas.drawCircle(Offset(cx + w * 0.18, cy + h * 0.18), 2.0, dot3);
